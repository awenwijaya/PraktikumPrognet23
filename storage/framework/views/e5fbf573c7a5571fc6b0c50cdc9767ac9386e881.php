							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										...
										<div class="home_slider_subtitle">Dapatkan Segera Produk Pakaian Terbaik Hanya di Estore.</div>
										<div class="button button_light home_button"><a href="#">Shop Now</a></div>
									</div>
								</div>
							</div>
			...
			<div class="avds_small">
				...
				<div class="avds_small_inner">
					...
					<div class="avds_small_content">
						...
						<div class="avds_text" style="background-color: rgba(0, 0, 0, 0.5)">Jangan sampai lewatkan ini #tampillebihelegant</div>
...
<?php echo $__env->make('layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\Prognet Kelompok 23\resources\views/home.blade.php ENDPATH**/ ?>