						...
						<?php $__currentLoopData = $products->product_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jpg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($loop->iteration == 1): ?>
								<div class="details_image_large"><img src="/uploads/product_images/<?php echo e($jpg->image_name); ?>" alt="">
									...
									?>
									<?php if($disc!=0): ?>
										<div style="background-color:red;" class="product_extra product_new"><a href="#">-<?php echo e($disc); ?>%</a></div>
									<?php endif; ?>
								</div>
				...
				<div class="col">
					...
					<div class="product_grid">
						...
						<div class="product">
							...
							<div class="product_image"><img src="/uploads/product_images/1591626884_oflame brush.Jpeg" alt=""></div>
...
<?php echo $__env->make('layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\Prognet Kelompok 23\resources\views/user/product.blade.php ENDPATH**/ ?>