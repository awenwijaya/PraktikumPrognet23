...
<body>
    <div class="container box">
        <form method="POST" class="box2" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data"><?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="new-password" title="Password minimal 8 Karakter">
...
unset($__errorArgs, $__bag); ?>
                ...
                <h6>Sudah memiliki akun? <a href="<?php echo e(route('login')); ?>">Login </a>
...
<?php /**PATH D:\semester 4\pratikum prognet\Prognet Kelompok 23\Prognet Kelompok 23\resources\views/auth/register.blade.php ENDPATH**/ ?>