                      ...
                      <div class="col-lg-4">
                        ...
                        <div class="card-body">
                          ...
                          <ul>
                            ...
                            <li>
                                <h5>Sub Biaya: Rp.<?php echo e($transaksi->sub_total); ?></h5>
                            </li>
                            <li>
                                <h5 id="biaya-ongkir">Biaya Pengiriman: Rp.<?php echo e($transaksi->shipping_cost); ?></h5>
                            </li>
                            <li>
                                <h5>Total Biaya: Rp.<?php echo e($transaksi->total); ?></h5>
                            </li>
                            <li>
                            <h5>Bukti Pembayaran: 
