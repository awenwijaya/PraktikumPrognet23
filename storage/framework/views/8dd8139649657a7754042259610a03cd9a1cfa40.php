...
<!-- Ionicons -->
<link href="<?php echo e(asset('https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')); ?>" rel="stylesheet">
...
<li class="dropdown head-dpdn">
    ...
    ?>
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-bell-o"></i><span class="badge"><?php echo e($notif_count); ?></span></a>
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
          <div class="profile_img"> 
            <span class="prfil-img">
              <img src="/uploads/avatars/<?php echo e(Auth::user()->profile_image); ?>" style="width:50px; height:50px; position:absolute; top:1px; left:-30px; border-radius:50%" alt="">
            </span> 
            <div class="user-name">
...
<!-- Right navbar links -->
  ...
  <footer class="main-footer">
     <strong>Copyright &copy; Kelompok 23 Program Internet.</strong>
  </footer>
...
</html>                     <?php /**PATH D:\semester 4\pratikum prognet\Prognet Kelompok 23\Prognet Kelompok 23\resources\views/layouts/transaksi.blade.php ENDPATH**/ ?>