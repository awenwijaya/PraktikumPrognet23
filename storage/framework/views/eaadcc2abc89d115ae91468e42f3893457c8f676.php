                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="position:relative; padding-left:50px;">
                                    <img src="/uploads/avatars/<?php echo e(Auth::user()->profile_image); ?>" style="width:32px; height:32px; position:absolute; top:5px; left:5px; border-radius:50%">
...
<?php /**PATH C:\Users\barud\Downloads\Compressed\Prognet Kelompok 23\resources\views/layouts/app.blade.php ENDPATH**/ ?>