            ...
            <table class="table product-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  ?>
                  <?php if($hasil != 0): ?>
                         <td> Rp<span class="float-lef grey-text price<?php echo e($loop->iteration-1); ?>"><?php echo e($hasil); ?></li>
                          Rp.<span class="float-lef grey-text"><small><s><?php echo e($item->price); ?></s></small></span>
                        </td>
                  <?php else: ?>
                          <td>Rp.<span class="float-lef grey-text price<?php echo e($loop->iteration-1); ?>"><?php echo e($item->price); ?></li></td>
                  <?php endif; ?>
                  ...
                  <?php if($hasil != 0): ?>
                         <td> Rp<span class="float-lef grey-text price<?php echo e($loop->iteration-1); ?>"><?php echo e($hasil); ?></li>
                          Rp<span class="float-lef grey-text"><small><s><?php echo e($item->product->price); ?></s></small></span></td>
                  <?php else: ?>
                          <td>Rp<span class="float-lef grey-text price<?php echo e($loop->iteration-1); ?>"><?php echo e($item->product->price); ?></li></td>
                  <?php endif; ?>
                  <td class="text-center text-md-left">
...
<?php echo $__env->make('layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\barud\Downloads\Compressed\Prognet Kelompok 23\resources\views/user/checkout.blade.php ENDPATH**/ ?>